...
Важно: Создать файл .env (с копированием .env.example) нужно вписать польз данные для подключения к БД. Еще вписать нужного пользователя в docker-compose.yml (radmin и его UID, для просмотра echo $UID). 
